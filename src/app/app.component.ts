 ...
 @Output() arraySeleccionados:Producto[];
  ...
  constructor(){
    this.arrayComida=[
      ...
      new Producto("Chicharron de pescado","https://i2.wp.com/www.berypez.pe/wp-content/uploads/2020/06/p04-chicharron-de-pescado.jpg",25),
    ...
    this.arrayBebida=[
      ...
      new Producto("Fanta","https://www.minimarketpeter.pe/wp-content/uploads/2020/05/FANTA-500.jpg",3.50),
